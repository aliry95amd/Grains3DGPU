...
__HOSTDEVICE__ static INLINE void
    FusedMinkowskiDifference(const Vector3<T>&    a,
                             const Vector3<T>&    b,
                             const Vector3<T>&    v,
                             ...
                             Vector3<T>&          w) noexcept
{
    ...
    bw[1] = ba[1] + bqa[3] * tya + bqa[2] * txa - bqa[0] * tza + bva[1] - bb[1]
            - bqb[3] * tyb - bqb[2] * txb + bqb[0] * tzb - bvb[1];
    bw[2] = ba[2] + bqa[3] * tza + bqa[0] * tya - bqa[1] * txa + bva[2] - bb[2]
            - bqb[3] * tzb - bqb[0] * tyb + bqb[1] * txb - bvb[2];
    // clang format on
}
